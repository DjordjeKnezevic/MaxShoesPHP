    ...
    <main id="second-page">
        ...
        <section id="frame">
            <nav class="navbar navbar-expand-lg dark-blue-bg">
                <div class="container-fluid">
                    ...
                    <div class="offcanvas offcanvas-end dark-blue-bg" tabindex="-1" id="offcanvasDarkNavbar"
                                ...
                                <ul class="navbar-nav flex-grow-1 pe-3">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu padajuci-meni text-white" id="ostali-filtri">
                                            <li class="d-flex flex-row justify-content-center dropdown-item"><input
                                                    type="checkbox" name="" id="on-discount"
                                                    class="form-check-input me-2 my-0" data-name="On Discount"><label
                                                    for="on-discount" class="form-check-label text-white">On
                                                    Discount</label></li>
                                            <li class="d-flex flex-row justify-content-center dropdown-item"><input
                                                    type="checkbox" name="" id="free-shipping"
                                                    class="form-check-input me-2 my-0" data-name="Free shipping"><label
                                                    for="free-shipping" class="form-check-label text-white">Free
                                                    shipping</label></li>
        ...
        <div class="alert alert-success d-flex align-items-center" role="alert" id="uspesno-dodato" style="opacity: 0;">
            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2"
                viewBox="0 0 16 16" role="img" aria-label="Warning:" width="15px" height="15px">
                <path
        ...
        <div class="alert alert-success d-flex align-items-center" role="alert" id="uspesno-skinuto"
            style="opacity: 0;">
            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2"
                viewBox="0 0 16 16" role="img" aria-label="Warning:" width="15px" height="15px">
                <path
