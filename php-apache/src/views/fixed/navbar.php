...
<nav class="navbar navbar-expand-lg dark-blue-bg navbar-meni">
    <div class="container-fluid">
        <div class="col navbar-brand">
            ...
            <div class="col navbar-brand">
                <a href="/index.php">
                    <h1 class=" text-light" id="logo-ime"><span class="lgreen">M</span>ax <span class="lgreen">S</span>hoes</h1>
                </a>
                <a href="/index.php"><img src="Assets/img/logo.jpg" alt="logo" class="ms-4"></a>
            </div>
        </div>
        <div class="col">
        ...
        <div class="col icons">
            <a class="text-light" id="glavna-korpa" href=<?php
                                                            if (isset($_SESSION["loggedUser"]))
                                                                echo "index.php?page=cart";
                                                            else
                                                                echo "#account-modal" . " data-bs-toggle='modal'"; ?>><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
                ...
                <div class="dropdown text-white mx-3" id="my-profile">
                    ...
                    <ul class="dropdown-menu lgreen-bg">
                        ...
                        <?php if ($_SESSION["loggedUser"]->type == "admin") {
                            echo "<li><a class='dropdown-item' href='index.php?page=adminpanel'>Go to admin panel</a></li>";
                        } ?>
            ...
            ?>
                ...
                <a class="text-light" id="profile" data-bs-toggle="modal" href="#account-modal" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
