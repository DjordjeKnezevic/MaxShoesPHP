    ...
    <div class="d-flex flex-column justify-content-center align-items-center" id="admin-drzac">
        ...
        <div class="d-flex justify-content-center" id="shoe-editor">
            <div class="col-md-4 p-3 d-flex flex-column align-items-center border">
                <h3>Insert</h3>
                <h5>Insert a shoe</h5>
                <form action="models/shoemanager.php" method="post" class="p-2 m-0" enctype="multipart/form-data">
                    <div class="form-group my-2">
                        <div class="d-flex justify-content-between"><label for="category-insert">Category:</label><strong class="required">Required!</strong>
                        </div>
                    ...
                    <div class="form-group my-2">
                        <div class="d-flex justify-content-between"><label for="brend-insert">Brand:</label><strong class="required">Required!</strong>
                        </div>
                    ...
                    <div class="form-group my-2">
                        ...
                        <input type="text" placeholder="Between 3 and 50 characters" name="model-insert" class="form-control my-1" id="model-insert">
                    </div>
                    <div class="form-group my-2">
                        ...
                        <input type="number" placeholder="Between 10 and 999 dollars" name="price-insert" class="form-control my-1" id="price-insert">
                    </div>
                    <div class="form-group my-2 border p-2">
                        <label for="discount-insert">Discount (format Decimal(3,2), leave blank for no
                            discounts):</label>
                        <input type="number" step="0.01" placeholder="Example: 0.70 if you want 30% discount" name="discount-insert" class="form-control my-1" id="">
                        <label for="discount-insert-start-date">Discount start date (leave blank for current
                            timestamp):</label>
                        <input type="datetime-local" name="discount-insert-start-date" id="discount-insert-start-date">
                    ...
                    <div class="form-group my-2">
                        <label for="shipping-insert">Shipping price (format Decimal(3,2), leave blank for free
                            shipping):</label>
                        <input type="number" placeholder="Between 10 and 999 dollars" name="shipping-insert" class="form-control my-1" id="shipping-insert">
                    </div>
                    <div class="form-group my-2">
            ...
            <div class="col-md-4 p-3 d-flex flex-column align-items-center border">
                ...
                <div class="form-group my-2">
                    <div class="d-flex justify-content-between"><label for="shoeid-update">Shoe:</label><strong class="required">Required!</strong>
                    </div>
                ...
                <form action="models/shoemanager.php" method="post" class="p-2 m-0" enctype="multipart/form-data" id="update-form">
                    <input type="text" name="id-update" id="id-selected" class="hide">
                    <input type="submit" name="updateShoe" value="Update Shoe" id="updateShoe" class="btn btn-primary form-control my-1">
                    <div class="hide alert alert-info mt-3 d-flex justify-content-between align-items-center processing" id="updateProcess">
                        <p class="d-inline-block">Proccessing request...</p>
                        <img src="Assets/img/loading.gif" alt="loading-img" class="img-fluid mx-2 loading-img">
                    </div>
                </form>
            ...
            <div class="col-md-4 p-3 d-flex flex-column align-items-center border">
                ...
                <div class="form-group my-2">
                    <div class="d-flex justify-content-between"><label for="shoeid-delete">Shoe:</label><strong class="required">Required!</strong>
                    </div>
                ...
                <form action="models/shoemanager.php" method="post" class="p-2 m-0 w-100">
                    <input type="text" name="id-delete" id="id-selected-delete" class="hide">
                    <input type="submit" name="deleteShoe" value="Delete Shoe" class="btn btn-primary form-control my-2" id="deleteShoe">
                    <div class="hide alert alert-info d-flex justify-content-between align-items-center processing mt-2" id="deleteProcess">
                        <p class="d-inline-block">Proccessing request...</p>
                        <img src="Assets/img/loading.gif" alt="loading-img" class="img-fluid mx-2 loading-img">
                    </div>
                </form>
