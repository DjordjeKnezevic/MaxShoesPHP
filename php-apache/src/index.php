...
<body>
    ...
    <main id="main-page">
        ...
        <section class="container" id="Akcije">
                ...
                <div class="carousel-indicators">
                    ...
                    $popularnePatike = array(
                        array(
                            'brend' => 'Asics',
                            'model' => 'Lite Show',
                            'link' => 'products.php?brand=Asics&amp;model=Lite Show',
                        ...
                        array(
                            'brend' => 'Asics',
                            'model' => 'Metaspeed Sky',
                            'link' => 'products.php?brand=Asics&amp;model=Metaspeed Sky',
                        ...
                        array(
                            ...
                            'link' => 'products.php?brand=Nike&amp;model=Pegasus Turbo Next Nature',
            ...
            <a href="/products.php?brand=Nike&discount=On Discount"><img src="Assets/img/NikeDiscount.jpg"
                    class="img-fluid" alt="NikeDiscount"></a>
        </section>
